...
namespace AISLab1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //GetInfoLaptopsByCPU("AMD R5 1600", laptops);
            //GetModelsLaptopByCompany();
            //GetModelsInRangePrice();
            //GetModelsWithRamMore();
            //AveragePriceByCompany();
            //GroupingByStore();
            //GetLaptopsInfoWithStoreInfo();
        }
